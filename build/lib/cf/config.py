...
@click.command()
@click.option("--username", prompt="Enter your pythoncf username")
@click.password_option()
@click.option("--cf_dir", prompt="Enter your pythoncf directory")
def config(username: str, password: str, cf_dir: str):
    """
    Configure the pythoncf cli.
    """
    ...
    with open(os.path.expanduser('~') + slash + "pythoncf.uwu", "w") as f:
